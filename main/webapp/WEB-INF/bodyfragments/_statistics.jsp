...
<c:url var="addSearch" value="/home/login/statistics/search" />
...
<sf:form method="post"
	action="${pageContext.request.contextPath}/home/login/statistics/search"
	modelAttribute="form">
	<div class="container mt-4"
		...
		<div class="row">
            ...
            <s:bind path="serviceName">
						<label for="inputEmail4" class="form-label">Service Category</label>
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options itemLabel="serviceName" itemValue="serviceName" items="${serviceList}"   />
								</sf:select>
            ...
            <s:bind path="dateOfBooking">
						<label for="inputEmail4" class="form-label">Date Of Booking</label>
		...
		<div class="table-responsive">
			<table class="table bg-header rounded shadow-sm table-hover mt-5" id="dtBasicExample" >
