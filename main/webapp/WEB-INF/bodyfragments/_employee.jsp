...
<div class="card" >
  <div class="card-body bg-header">
    <h5 class="card-title text-center ">Professional Sign Up</h5>
    <hr>
     <b><%@ include file="businessMessage.jsp"%></b>
    <sf:form method="post" action="${pageContext.request.contextPath}/home/employee-register"
    	...
    	<div class="col-lg-4">
            ...
            <s:bind path="address">
						...
						<sf:textarea path="${status.expression}"
							placeholder="Enter address" id="datepicker" class="form-control" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
		    </s:bind>
     ...
     <div class="row">
    	<div class="col-lg-4">
            ...
            <s:bind path="password">
						...
						<sf:input type="password" id="passInput" path="${status.expression}"
						  class="form-control" />
    	...
    	<div class="form-outline ">
            <s:bind path="skill1">
						...
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options   items="${skills}" /></sf:select>
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
		    </s:bind>
    ...
    <!-- IVth row ends -->
     <div class="row">
    	<div class="col-lg-3">
    		<div class="form-outline ">
             <s:bind path="skill2">
						<label for="inputEmail4" class="form-label">Skills 2</label>
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options   items="${skills}" /></sf:select>
						<font color="red" style="font-size: 13px"><sf:errors
    	...
    	<div class="form-outline ">
            <s:bind path="skill_3">
						<label for="inputEmail4" class="form-label">Skills 3</label>
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options   items="${skills}" /></sf:select>
						<font color="red" style="font-size: 13px"><sf:errors
    	...
    	<div class="form-outline ">
            <s:bind path="skill_4">
						<label for="inputEmail4" class="form-label">Skills 4</label>
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options   items="${skills}" /></sf:select>
						<font color="red" style="font-size: 13px"><sf:errors
    	...
    	<div class="form-outline ">
            <s:bind path="skill_5">
						<label for="inputEmail4" class="form-label">Skills 5</label>
						<sf:select class="form-control" path="${status.expression}">
									<sf:option value="" label="---Select---" />
									<sf:options   items="${skills}" /></sf:select>
						<font color="red" style="font-size: 13px"><sf:errors
    ...
    <!-- Upload Image  -->
     <div class="row">
    	...
    	<div class="form-outline ">
            <s:bind path="kyc">
						<label for="inputEmail4" class="form-label">Upload KYC</label>
						<sf:input type="file" path="${status.expression}"
							class="form-control" required="required" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
    ...
    <div class="row">
    <div class="form-outline ">
            <s:bind path="paymentLink">
						<label for="inputEmail4" class="form-label">Payment Link</label>
						<sf:input type="text" placeholder="Enter Payment Link"  path="${status.expression}"
						  class="form-control" />
